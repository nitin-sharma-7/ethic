    ...
    <section className="pb-12">
        ...
        <div className="p-6 sm:p-9">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
            ...
            <p className="text-gray-600 text-sm md:text-base md:max-w-md">
              ...
              providing strategic guidance, innovative solutions, and expert
              support. We are dedicated to helping businesses unlock their full
              potential, optimize performance, and achieve sustainable growth.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="border-l-2 border-gray-300 pl-4">
              ...
              <p className="text-gray-600 text-sm">
                We help financial sponsors drive higher return on their
                investments through strategic analysis of target companies.
              </p>
            </div>
            ...
            <div className="border-l-2 border-gray-300 pl-4">
              ...
              <p className="text-gray-600 text-sm">
                We help corporate management teams increase shareholder value
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-12 gap-6">
              ...
              <p className="text-gray-600 max-w-lg text-sm sm:text-base">
                ...
                hands-on support to help businesses grow and thrive.
              </p>
            </div>
      ...
      <section className="flex flex-col md:flex-row items-center md:items-start md:justify-between py-16 px-6 md:px-20 bg-white">
        ...
        <div className="relative md:w-1/2 w-full">
          <img
            src="/image (a).png" // replace with your image path
            alt="Building"
        ...
        <div className="md:w-1/2 w-full mt-8 md:mt-0 md:pl-12">
          ...
          <p className="mt-6 text-gray-600 text-md max-w-md">
            ...
            streamlining IT systems, or driving digital transformation, Execor
            is your trusted partner in achieving sustainable growth.
          </p>
        </div>
      </section>
    </section>
